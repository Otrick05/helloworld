      ...
      if (balance[answcuenta-1]>0){
        do{
            ...
            }else if (answw>0 && answw<=counter)
            {
                ...
                infogastos[controlhistgastos]+=" **Categoría: "+catgastos[answw-1]+"** Cuenta :"+ cuenta[answcuenta-1] + " -$"+ filler+" **"+ desc ;
                balance[answcuenta-1]-=answdinero;
                controlhistgastos+=1;
                cout<<"GASTO AÑADIDO EXITOSAMENTE!"<<endl;
 ...
 cout<<"Ingrese el 0 para Volver al menú principal, ingrese otro numero para crear la nueva cuenta :";
   cin>>answw;
    if (answw!=0){
        cin.ignore();
        string nombrecuenta;
     cout<<"Solo se permiten de 3 a 25 caracteres para el nombre de su Gategoria de gastos"<<endl;
     cout<<"Digite el nombre de la nueva Categoría de gastos :'\n'";
     getline(cin,nombrecuenta); 
     
        if (nombrecuenta.length()>=3 && nombrecuenta.length()<=25 && cuenta[19]=="??"){      
            checkcatgastos();     
            cout<<"Categoria de gastos añadida exitosamente!"<<endl;
            catgastos[controlgastos]=nombrecuenta;
            controlhistgastos+=1;           
...
void crearacc(){
int answw;
 cout<<"Ingrese el 0 para Volver al menú principal, ingrese otro numero para crear la nueva Cuenta de ingresos/egresos:";
   cin>>answw;
    if (answw!=0){
        cin.ignore();
        string nombrecuenta;
     cout<<"Solo se permiten de 5 a 20 caracteres para el nombre de su Cuenta de Ingresos/Egresos"<<endl;
     cout<<"Digite el nombre de la nueva Cuenta :'\n'";
     getline(cin,nombrecuenta); 
     
        if (nombrecuenta.length()>=5 && nombrecuenta.length()<=20){      
     
            cout<<"Categoria de gastos añadida exitosamente!"<<endl;
            cuenta[checkcuenta()]=nombrecuenta;
